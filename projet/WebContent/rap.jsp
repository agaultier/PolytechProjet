...
<body>
 ...
 <!-- Navigation -->
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         ...
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <li class="nav-item">
            <a class="nav-link" href="recherche.jsp">Recherche/Liste artistes</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="py-5">
    <div class="container">
      <h1>Rap</h1>
      <p class="lead">Sur cette page nous parlerons de Rap, un style très varié.</p>
      <p>Ici vous avez un aperçu</p>
    <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/740178957&color=%23008c8c&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/soundcloud-hustle" title="Hustle: Rap &amp; Hip-Hop" target="_blank" style="color: #cccccc; text-decoration: none;">Hustle: Rap &amp; Hip-Hop</a> · <a href="https://soundcloud.com/soundcloud-hustle/sets/chill-trap-for-deep-focus" title="Trap for Deep Focus: Chill Trap" target="_blank" style="color: #cccccc; text-decoration: none;">Trap for Deep Focus: Chill Trap</a></div>
    </div>
  </section>
